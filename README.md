...
คาถาที่ท่องซ้ำหลายจบ ให้ตัดท่อนที่ท่องออกมาเป็นไฟล์เดี่ยว แล้วประกาศเป็น `parts`
ในไฟล์บท — ท่อนไหนใส่ `rounds` ไว้ ผู้ฟังจะปรับจำนวนจบเองได้ตอนฟัง
ดู `content/chants/maha-chakkraphat.json` เป็นตัวอย่าง
